...
use super::{AnnounceEvent, Tracker};
    ...
    D: serde::Deserializer<'de>,
{
    ...
    match PeerFormat::deserialize(deserializer)? {
        ...
        PeerFormat::Compact(bytes) => {
            deserialize_compact_peers(&bytes).map_err(serde::de::Error::custom)
        }
    }
}
...
mod tests {
    ...
    use super::{HTTPAnnounceResponse, HTTPAnnounceResponsePeer};
